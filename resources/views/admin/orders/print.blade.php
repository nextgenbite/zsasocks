...
@media print {
    ...
    /* Force a page break before each order */
    .order-page {
            ...
            <div class="card">
                <div class="card-body">
                    <div id="printArea">
                        ...
                        <div class="{{$loop->first ? '' : 'order-page'}} container-fluid">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class=" pr-0">
                                    <p class="mb-0 mt-2  text-end  ">Order Status : @include('admin.pertials.order_print_status', ['item' =>$order])</p>
                              </div>
                            </div>
